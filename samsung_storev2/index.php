...
$siswa = query("SELECT * FROM smartphone");
?>
...
<table id="tabel1">
    ...
    <tr>
        <td>
            <center><a style="padding: 20px; color: black; font-weight: bold; padding: 10px; padding-right: 60px; padding-left: 60px; background: white; border-radius: 10px;" href="create.php  #tabel1">Add New Data</a></center>
        </td>
    </tr>
</table>
<body>
<table border="1" cellpadding="10" cellspacing="0" id="tabel2">
        <tr>
            <th>No</th>
            <th>id</th>
            <th>Tanggal Lahir</th>
        ...
        <?php foreach($siswa as $sis) {?>
            ...
            <td><?php echo $sis["tipe"];?></td>
            <td><?php echo $sis["processor"]; ?></td>
            <td><?php echo $sis["memory"]; ?></td>
            <td><?php echo $sis["color"]; ?></td>
            <td><?php echo $sis["price"]; ?></td>
            <td> 
                <a style="color: #95BDFF;"  href="edit.php?id= <?php echo $sis["id"] ;?> #tabel1">Ubah</a> | 
                <a style="color: #95BDFF;"  href="delete.php?id= <?php echo $sis["id"] ;?>">Hapus</a>
            </td>
